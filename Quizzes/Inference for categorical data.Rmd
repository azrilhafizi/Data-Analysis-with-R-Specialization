...
me <- z_star_95 * sqrt((p_hat * (1 - p_hat)) / n)
```
...
my12 <- atheism %>%
  filter(nationality == "Malaysia" , year == "2012")

pol12 <- atheism %>% 
  filter(nationality == "Poland", year == "2012")

inference(y = response, data = my12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
...
inference(y = response, x = as.factor(year), data = spain, type = "ht", statistic = "proportion", method = "theoretical", null = 0, alternative = "twosided", success = "atheist")
```
...
inference(y = response, x = as.factor(year), data = us, type = "ht", statistic = "proportion", method = "theoretical", null = 0, alternative = "twosided", success = "atheist")
```
