...
```{r habit-weight-box}
ggplot(nc, aes(habit, weight, fill = habit)) +
  geom_boxplot()
```
...
```{r gained-mature-ht}
inference(y = weight, x = mature, data = nc, statistic = "mean", type = "ht", 
          method = "theoretical", order = c("younger mom","mature mom"), null = 0, 
...
<li> **The maximum age of younger moms is 34 and minimum age of mature moms is 35.** </li>
